...
namespace H264_Player
{
    public sealed unsafe class VideoStreamDecoder : IDisposable
    {
        ...
        public VideoStreamDecoder(string url)
        {
            ...
            int x = ffmpeg.av_seek_frame(_pFormatContext, _streamIndex, 1000000, ffmpeg.AVSEEK_FLAG_FRAME);
            if (x >= 0) {
                x = 7;
            }
            ...
            if (pStream == null) throw new InvalidOperationException("Could not find a video stream.");
            ...
            Duration = _pFormatContext->duration / ffmpeg.AV_TIME_BASE;
            if (Duration < 0) {
                Duration = 1000;
            }
